...
0. **Prerequisite:** [progress.md](./progress.md) is for you to manage planned tasks while the user can check it to see the progress. Read it at every session start.
